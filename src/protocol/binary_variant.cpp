...
namespace OpcUa
{
    ...
    bool Variant::operator== (const Variant& var) const
    {
        ...
        */
        ...
        throw std::logic_error(__FUN(std::string("Unknown variant type '") + t.name() + std::string("'.")));
    }
    ...
    VariantType Variant::Type() const
    {
        ...
        */
        ...
        throw std::runtime_error(__FUN(std::string("Unknown variant type '") + t.name() + "'."));
    }
    ...
    ObjectId VariantTypeToDataType(VariantType vt)
    {
        ...
        default:
        {
            throw std::runtime_error(__FUN("Unknown variant type."));
        }
        }
    }
    ...
    VariantType DataTypeToVariantType(const NodeId& dataType)
    {
        if (dataType.GetNamespaceIndex())
        {
            ...
            throw std::runtime_error(__FUN(msg + ToString(dataType)));
        }
    ...
    namespace Binary
    {
        ...
        void DataDeserializer::Deserialize<Variant>(Variant& var)
        {
            ...
            */
            ...
            {
                throw std::logic_error(__FUN("Deserialization of VariantType: " + std::to_string(encodingMask) + " is not supported yet."));
            }
