    ...
    namespace Binary
    {
        ...
        std::size_t RawSize(const NotificationData& data)
        {
            ...
            else
            {
                ...
                //throw std::runtime_error(__FUN("Uknown notificationData type"));
            }
        ...
        void DataDeserializer::Deserialize<NotificationData>(NotificationData& data)
        {
            *this >> data.Header;
            ...
            {
                //Unknown type, we just ignore it
                //throw std::runtime_error(__FUN("Uknown notification data type found in NotificationData"));
            }
        }
        ...
        void DataSerializer::Serialize<NotificationData>(const NotificationData& data)
        {
            *this << data.Header;
            ...
            {
                //Unknown type, we just ignore it
                //throw std::runtime_error(__FUN("Uknown notification data type found in NotificationData"));// + itos(data.Header.TypeId.FourByteData.Identifier) );
            }
        }
    } // namespace Binary
} // namespace OpcUa
