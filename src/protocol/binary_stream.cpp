...
namespace
{
    ...
    {
        throw std::logic_error(__FUN("Not enough data was received from channel."));
    }
...
namespace OpcUa
{
        ...
        : Value(num)
    {
        if (!Value)
        {
            throw std::invalid_argument(__FUN("IntegerId cannot be zero"));
        }
    }
    ...
    namespace Binary
    {
        ...
        void DataSerializer::Serialize<OpcUa::Binary::MessageType>(const OpcUa::Binary::MessageType& value)
        {
            ...
            default:
                throw std::logic_error(__FUN("Invalid message type."));
            }
        ...
        void DataDeserializer::Deserialize<OpcUa::Binary::MessageType>(OpcUa::Binary::MessageType& value)
        {
            ...
            else
            {
                ...
                msg += "] received.";
                throw std::logic_error(__FUN(msg));
            }
        }
        ...
        void DataSerializer::Serialize<OpcUa::Binary::ChunkType>(const OpcUa::Binary::ChunkType& value)
        {
            ...
            default:
                throw std::logic_error(__FUN("Invalid Chunk Type"));
            }
        }
        ...
        void DataDeserializer::Deserialize<OpcUa::Binary::ChunkType>(OpcUa::Binary::ChunkType& value)
        {
            ...
            default:
                throw std::logic_error(__FUN("Invalid chunk type received."));
            };
        }
