...
namespace OpcUa
{
    namespace Server
    {
        ...
        OpcTcpMessages::OpcTcpMessages(OpcUa::Services::SharedPtr server, OpcUa::OutputChannel::SharedPtr outputChannel, const Common::Logger::SharedPtr& logger)
            ...
            , SequenceNb(0)
        {
            LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | SessionId; {}"), SessionId);
        }
        ...
        OpcTcpMessages::~OpcTcpMessages()
        {
            ...
            {
                LOG_ERROR(Logger, __FUN("opc_tcp_processor     | stopping OpcTcpMessages failed: {}"), exc.what());
            }
        }
        ...
        bool OpcTcpMessages::ProcessMessage(MessageType msgType, IStreamBinary& iStream)
        {
            ...
            case MT_HELLO:
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | accepted hello message"));
            ...
            case MT_SECURE_OPEN:
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | opening secure channel"));
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | closing secure channel"));
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing secure message"));
            ...
            case MT_ACKNOWLEDGE:
            {
                LOG_ERROR(Logger, __FUN("opc_tcp_processor     | received acknowledge from client: this should not have happend..."));

                throw std::logic_error(__FUN("Thank to client about acknowledge."));
            }

            case MT_ERROR:
            {
                LOG_ERROR(Logger, __FUN("opc_tcp_processor     | client signaled an error"));

                throw std::logic_error(__FUN("It is very nice get to know server about error in the client."));
            }

            default:
            {
                LOG_ERROR(Logger, __FUN("opc_tcp_processor     | unknown message type '{}' received"), msgType);

                throw std::logic_error(__FUN("unknown message type received."));
            }
            }
        ...
        void OpcTcpMessages::ForwardPublishResponse(const PublishResult result)
        {
            ...
            LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | sending PublishResult to client"));
            ...
            if (!outputChannel) {
                LOG_WARN(Logger, __FUN("opc_tcp_processor     | parent instance already deleted"));
                return;
            }

            if (PublishRequestQueue.empty())
            {
                LOG_WARN(Logger, __FUN("error trying to send publish response while we do not have data from a PublishRequest"));
                return;
            }
            ...
            LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | sending PublishResponse with: {} PublishResults"), response.Parameters.NotificationMessage.NotificationData.size());
        ...
        void OpcTcpMessages::HelloClient(IStreamBinary& istream, OStreamBinary& ostream)
        {
            ...
            LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | reading hello message"));
            ...
            LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | sending answer"));
        ...
        void OpcTcpMessages::OpenChannel(IStreamBinary& istream, OStreamBinary& ostream)
        {
            ...
            {
                throw std::logic_error(__FUN(std::string("Client want to create secure channel with unsupported policy '") + algorithmHeader.SecurityPolicyUri + std::string("'")));
            }
            ...
            {
                throw std::logic_error(__FUN("Unsupported security mode."));
            }
        ...
        void OpcTcpMessages::ProcessRequest(IStreamBinary& istream, OStreamBinary& ostream)
        {
            ...
            */
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing 'Get Endpoints' request"));
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing 'Find Servers' request"));
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing 'Browse' request"));
            ...
            case OpcUa::READ_REQUEST:
            {
                ...
                {
                    Logger->debug(__FUN("opc_tcp_processor     | processing 'Read' request for Node:"));
                    ...
                    for (ReadValueId id : params.AttributesToRead)
                    {
                        ...
                        Logger->debug(__FUN("opc_tcp_processor     |   {} ({})"), id.NodeId, name);
                    }
                }
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing 'Write' request"));
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing 'Translate Browse Paths To Node Ids' request"));
                ...
                if (Logger && Logger->should_log(spdlog::level::debug))
                {
                    for (BrowsePath path : params.BrowsePaths)
                    {
                        ...
                        Logger->debug(__FUN("opc_tcp_processor     | requested path is: {}"), result.str());
                    }
                }
                ...
                if (Logger && Logger->should_log(spdlog::level::debug))
                {
                    for (BrowsePathResult res : result)
                    {
                        ...
                        Logger->debug(__FUN("opc_tcp_processor     | result of browsePath is: {}, target is: {}"), (uint32_t)res.Status, target.str());
                    }
                }
                ...
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | sending response to 'Translate Browse Paths To Node Ids' request"));
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing 'Create Session' request"));
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing 'Activate Session' request"));
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing 'Close Session' request"));
                ...
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | session closed"));
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing 'Create Subscription' request"));
                ...
                response.Data = Server->Subscriptions()->CreateSubscription(request, [self](PublishResult i)
                    {
                        ...
                        catch (std::exception& ex)
                        {
                            ...
                            LOG_WARN(self->Logger, __FUN("error forwarding PublishResult to client: {}"), ex.what());
                        }
                    });
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing 'Modify Subscription' request"));
                ...
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | sending response to 'Modify Subscription' request"));
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing 'Delete Subscription' request"));
                ...
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | sending response to 'Delete Subscription' request"));
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing 'Create Monitored Items' request"));
                ...
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | sending response to 'Create Monitored Items' request"));
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing 'Delete Monitored Items' request"));
                ...
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | sending response to 'Delete Monitored Items' request"));
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing 'Publish' request"));
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing 'Set Publishing Mode' request"));
                ...
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | sending response to 'Set Publishing Mode' request"));
                ostream << secureHeader << algorithmHeader << sequence << response << flush;
                return;
            }
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing 'Add Nodes' request"));
                ...
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | sending response to 'Add Nodes' request"));
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing 'Add References' request"));
                ...
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | sending response to 'Add References' request"));
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing 'Republish' request"));
                ...
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | sending response to 'Republish' request"));
            ...
            case CALL_REQUEST:
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing 'Call' request"));
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing 'Register Nodes' request"));
                ...
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | sending response to 'Register Nodes' request"));
            ...
            {
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | processing 'Unregister Nodes' request"));
                ...
                LOG_DEBUG(Logger, __FUN("opc_tcp_processor     | sending response to 'Unregister Nodes' request"));
            ...
            default:
            {
                ...
                LOG_WARN(Logger, __FUN("opc_tcp_processor     | sending 'ServiceFaultResponse' to unsupported request of id: {}"), message);
