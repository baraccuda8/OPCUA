...
namespace OpcUa
{
    namespace Internal
    {
        InternalSubscription::InternalSubscription(SubscriptionServiceInternal& service, const SubscriptionData& data, const NodeId& SessionAuthenticationToken, std::function<void(PublishResult)> callback, const Common::Logger::SharedPtr& logger)
            ...
            , Logger(logger)
        {
            LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, create"), Data.SubscriptionId);
        }

        void InternalSubscription::Start()
        {
            LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, start"), Data.SubscriptionId);
        ...
        {
            //Stop();
            LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, destroy"), Data.SubscriptionId);
        }

        void InternalSubscription::Stop()
        {
            LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, stop"), Data.SubscriptionId);
        ...
        {
            LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, DeleteAllMonitoredItems"), Data.SubscriptionId);
        ...
        bool InternalSubscription::HasExpired()
        {
            ...
            if (expired)
            {
                LOG_DEBUG(Logger, __FUN("internal_subscription | id: {} has expired: keep alive: {} > life time: {}"), Data.SubscriptionId, KeepAliveCount, LifeTimeCount);
            }
        ...
        void InternalSubscription::PublishResults(const boost::system::error_code& error)
        {
            if (error)
            {
                LOG_WARN(Logger, __FUN("internal_subscription | id: {}, PublishResults: error: stopping subscription timer"), Data.SubscriptionId);
                return;
            }
            ...
            if (HasPublishResult() && Service.PopPublishRequest(CurrentSession))   //Check we received a publishrequest before sending response
            {
                ...
                if (results.size() > 0)
                {
                    LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, have {} results"), Data.SubscriptionId, results.size());

                    if (Callback)
                    {
                        LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, calling callback"), Data.SubscriptionId);
                        Callback(results[0]);
                    }

                    else
                    {
                        LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, no callback defined for this subscription"), Data.SubscriptionId);
                    }
                }
            }
        ...
        bool InternalSubscription::HasPublishResult()
        {
            ...
            {
                LOG_TRACE(Logger, __FUN("internal_subscription | id: {}, HasPublishResult: all queues empty, should send publish event"), Data.SubscriptionId);
                return true;
            }

            if (KeepAliveCount > Data.RevisedMaxKeepAliveCount)   //we need to send keepalive notification
            {
                LOG_TRACE(Logger, __FUN("internal_subscription | id: {}, HasPublishResult: KeepAliveCount: {} > MaxKeepAliveCount: {}, should send publish event"), Data.SubscriptionId, KeepAliveCount, Data.RevisedMaxKeepAliveCount);
                return true;
            }

            LOG_TRACE(Logger, __FUN("internal_subscription | id: {}, HasPublishResult: KeepAliveCount: {}, MaxKeepAliveCount: {}"), Data.SubscriptionId, KeepAliveCount, Data.RevisedMaxKeepAliveCount);
            ++KeepAliveCount;
            return false;
        ...
        std::vector<PublishResult> InternalSubscription::PopPublishResult()
        {
            ...
            LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, PopPublishResult: {} queued items"), Data.SubscriptionId, TriggeredDataChangeEvents.size());
            ...
            {
                LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, PopPublishResult: {} events to send"), Data.SubscriptionId, TriggeredEvents.size());
            ...
            LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, sending PublishResult with: {} notifications"), Data.SubscriptionId, result.NotificationMessage.NotificationData.size());
        ...
        {
            LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, Republish request for sequence: {}"), Data.SubscriptionId, params.RetransmitSequenceNumber);
        ...
        {
            LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, ModifySubscription"), Data.SubscriptionId);
        ...
        {
            LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, CreateMonitoredItem"), Data.SubscriptionId);
            ...
            uint32_t callbackHandle = 0;
            {
                ...
                {
                    LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, subscribe to event notifier"), Data.SubscriptionId);
                    LOG_TRACE(Logger, __FUN("internal_subscription | id: {}, {}"), Data.SubscriptionId, result.FilterResult);
            ...
            if (request.ItemToMonitor.AttributeId != AttributeId::EventNotifier)
            {
                LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, subscribe to data changes"), Data.SubscriptionId);
            ...
            // Do not lock this part as it (indirectly) calls a locked AddressSpaceInMemory
            // function.
            LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, created MonitoredItem id: {}, ClientHandle: {}"), Data.SubscriptionId, result.MonitoredItemId, mdata.ClientHandle);
        ...
        {
            LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, TriggerDataChangeEvent: ClientHandle: {}"), Data.SubscriptionId, monitoreditems.ClientHandle);
        ...
        std::vector<StatusCode> InternalSubscription::DeleteMonitoredItemsIds(const std::vector<uint32_t>& monitoreditemsids)
        {
            ...
            {
                LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, DeletingMonitoredItemsIds: handle: {}"), Data.SubscriptionId, handle);
        ...
        bool InternalSubscription::DeleteMonitoredDataChange(uint32_t handle)
        {
            ...
            else
            {
                ...
                for (auto ev = TriggeredDataChangeEvents.begin(); ev != TriggeredDataChangeEvents.end();)
                {
                    ...
                    {
                        LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, remove TriggeredDataChangeEvents of MonitoredItemId: {}"), Data.SubscriptionId, handle);
            ...
            for (auto pair : MonitoredEvents)
            {
                if (pair.second == handle)
                {
                    ...
                    for (auto ev = TriggeredEvents.begin(); ev != TriggeredEvents.end();)
                    {
                        if (ev->MonitoredItemId == handle)
                        {
                            LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, remove TriggeredEvents of MonitoredItemId: {}"), Data.SubscriptionId, handle);
        ...
        void InternalSubscription::DataChangeCallback(const uint32_t& m_id, const DataValue& value)
        {
            ...
            {
                LOG_WARN(Logger, __FUN("internal_subscription | id: {}, DataChangeCallback called for unknown item: {}"), Data.SubscriptionId, m_id);
                return;
            }
            ...
            LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, enqueue TriggeredDataChange event: ClientHandle: {}"), Data.SubscriptionId, event.Data.ClientHandle);
        ...
        void InternalSubscription::TriggerEvent(NodeId node, Event event)
        {
            ...
            {
                LOG_DEBUG(Logger, __FUN("internal_subscription | id: {} does not monitor NodeId: {}"), Data.SubscriptionId, node);
        ...
        {
            LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, EnqueEvent: {}"), Data.SubscriptionId, event);
            ...
            {
                LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, MonitoredItemId: {} is already deleted"), Data.SubscriptionId, monitoredItemId);
        ...
        std::vector<Variant> InternalSubscription::GetEventFields(const EventFilter& filter, const Event& event)
        {
            ...
            LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, GetEventFields: filter size: {}"), Data.SubscriptionId, filter.SelectClauses.size());

            for (SimpleAttributeOperand sattr : filter.SelectClauses)
            {
                LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, BrowsePath size: {}"), Data.SubscriptionId, sattr.BrowsePath.size());
                ...
                {
                    LOG_DEBUG(Logger, __FUN("internal_subscription | id: {}, send value for: {}"), Data.SubscriptionId, sattr.BrowsePath[0]);
                    ...
                    {
                        LOG_DEBUG(Logger, __FUN("internal_subscription | message is: {}"), event.Message);
