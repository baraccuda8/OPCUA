...
namespace
{
    ...
    inline VariantType ConvertToVariantType(ObjectId id)
    {
        ...
        if (id == ObjectId::Boolean)
            return VariantType::BOOLEAN;
        if (id == ObjectId::SByte)
            return VariantType::SBYTE;
        if (id == ObjectId::Byte)
            return VariantType::BYTE;
        if (id == ObjectId::Int16)
            return VariantType::INT16;
        if (id == ObjectId::UInt16)
            return VariantType::UINT16;
        if (id == ObjectId::Integer)
            return VariantType::INT32;
        if (id == ObjectId::Enumeration)
            return VariantType::INT32;
        if (id == ObjectId::Int32)
            return VariantType::INT32;
        if (id == ObjectId::UInt32)
            return VariantType::UINT32;
        if (id == ObjectId::Int64)
            return VariantType::INT64;
        if (id == ObjectId::UInt64)
            return VariantType::UINT64;
        if (id == ObjectId::Float)
            return VariantType::FLOAT;
        if (id == ObjectId::Double)
            return VariantType::DOUBLE;
        if (id == ObjectId::String)
            return VariantType::STRING;
        if (id == ObjectId::ByteString)
            return VariantType::BYTE_STRING;
        if (id == ObjectId::DateTime)
    ...
    inline ObjectId ConvertToObjectId(VariantType type)
    {
        ...
        if (type == VariantType::STRING)
            return ObjectId::String;
        if (type == VariantType::BYTE_STRING)
            return ObjectId::ByteString;
        if (type == VariantType::DATE_TIME)
            return ObjectId::DateTime;
