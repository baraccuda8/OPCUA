...
namespace
{
    ...
    public:
        ...
        T WaitForData(std::chrono::milliseconds msec)
        {
            ...
            {
                //throw std::runtime_error(__FUN("Response timed out"));
                throw std::exception(__FUN((std::string("Response timed out ") + std::to_string(msec.count()) + " ms.")));
            }
            ...
            if (Data.empty())
            {
                LOG_WARN(Logger, __FUN("binary_client         | received empty packet from server"));
            }
    ...
    public:
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | CallbackThread: post -->"));
        ...
        void Run()
        {
            while (true)
            {
                LOG_DEBUG(Logger, __FUN("binary_client         | CallbackThread: waiting for next post"));
                ...
                if (StopRequest)
                {
                    LOG_DEBUG(Logger, __FUN("binary_client         | CallbackThread: exited"));
                ...
                while (!Queue.empty())   //to avoid crashing on spurious events
                {
                    ...
                    LOG_DEBUG(Logger, __FUN("binary_client         | CallbackThread: calling callback"));
                    callback();
                    LOG_DEBUG(Logger, __FUN("binary_client         | CallbackThread: callback finished"));
        ...
        void Stop()
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | CallbackThread: stopping"));
    ...
    public:
            ...
            ReceiveThread = std::thread([this]()
                {
                    ...
                    catch (const std::exception& exc)
                    {
                        ...
                        //LOG_ERROR(Logger, __FUN("binary_client         | ReceiveThread: error receiving data: {}"), exc.what());
                    }
                    catch(...)
                    {
                        //LOG_ERROR(Logger, __FUN("binary_client         | ReceiveThread: error receiving data: Unknown error"));
                    }
                }
            );
        }
        ...
        ~BinaryClient()
        {
            ...
            LOG_DEBUG(Logger, __FUN("binary_client         | stopping callback thread"));

            CallbackService.Stop();

            LOG_DEBUG(Logger, __FUN("binary_client         | joining service thread"));

            callback_thread.join(); //Not sure it is necessary

            Channel->Stop();

            LOG_DEBUG(Logger, __FUN("binary_client         | joining receive thread"));

            ReceiveThread.join();

            LOG_DEBUG(Logger, __FUN("binary_client         | receive thread stopped"));
        }
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | CreateSession -->"));
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | ActivateSession -->"));
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | CloseSession -->"));
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | AbortSession -->"));
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | DeleteNodes -->"));
    ...
    public:
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | Read -->"));
            if (Logger && Logger->should_log(spdlog::level::trace))
            {
                for (ReadValueId attr : params.AttributesToRead)
                {
                    Logger->trace(__FUN("binary_client         | Read: node id: {} attr id: {}"), attr.NodeId, ToString(attr.AttributeId));
                }
            }
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | Write -->"));
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | FindServers -->"));
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | GetEndpoints -->"));
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client          | Call -->"));
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | AddNodes -->"));
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | AddReferences -->"));
        ...
        {
            LOG_WARN(Logger, __FUN("binary_client         | SetMethod has no effect on client!"));
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | CreateSubscription -->"));

            const CreateSubscriptionResponse response = Send<CreateSubscriptionResponse>(request);

            LOG_DEBUG(Logger, __FUN("binary_client          | got CreateSubscriptionResponse"));
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | ModifySubscription -->"));
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | DeleteSubscriptions -->"));
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | CreateMonitoredItems -->"));
            LOG_TRACE(Logger, __FUN("binary_client         | {}"), parameters);
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | DeleteMonitoredItems -->"));
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | Publish --> request with {} acks"), originalrequest.SubscriptionAcknowledgements.size());
            ...
            {
                LOG_DEBUG(Logger, __FUN("binary_client         | got publish response, from server"));

                PublishResponse response;

                if (h.ServiceResult != OpcUa::StatusCode::Good)
                {
                    LOG_DEBUG(Logger, __FUN("-->responseCallback"));
                ...
                CallbackService.post([this, response]()
                    {
                        ...
                        {
                            LOG_DEBUG(Logger, __FUN("binary_client         | calling callback for Subscription: {}"), response.Parameters.SubscriptionId);
                            ...
                            {
                                LOG_WARN(Logger, __FUN("binary_client         | unknown SubscriptionId {}"), response.Parameters.SubscriptionId);
                            }
                            ...
                            else
                            {
                                ...
                                {
                                    LOG_WARN(Logger, __FUN("binary_client         | error calling application callback: {}"), ex.what());
                                }
                                catch(...)
                                {
                                    LOG_WARN(Logger, __FUN("binary_client         | error calling application callback"));
                                }
                            }
                        }
                        ...
                        {
                            LOG_WARN(Logger, __FUN("binary_client         | session is closed"));
                        }

                        else
                        {
                            // TODO
                            LOG_DEBUG(Logger, __FUN("binary_client         | not implemented"));
                        }
                    });
            };
            LOG_DEBUG(Logger, __FUN("-->responseCallback"));
            ...
            LOG_DEBUG(Logger, __FUN("binary_client         | Publish  <--"));
        }

        virtual RepublishResponse Republish(const RepublishParameters& params) override
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | Republish -->"));

            RepublishRequest request;
            request.Header = CreateRequestHeader();
            request.Parameters = params;

            LOG_DEBUG(Logger, __FUN("-->Republish:Send"));
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | TranslateBrowsePathsToNodeIds -->"));
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | Browse -->"));
            if (Logger && Logger->should_log(spdlog::level::trace))
            {
                for (BrowseDescription desc : query.NodesToBrowse)
                {
                    Logger->trace(__FUN("Node: {}"), desc.NodeToBrowse);
                }
            }
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | BrowseNext -->"));
            ...
            {
                LOG_DEBUG(Logger, __FUN("binary_client         | BrowseNext <-- no Continuation point, no need to send browse next request"));
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | RegisterNodes -->"));
            if (Logger && Logger->should_log(spdlog::level::trace))
            {
                Logger->trace(__FUN("binary_client         | Nodes to register:"));

                for (auto& param : params)
                {
                    Logger->trace(__FUN("    {}"), param);
                }
            }
            ...
            if (Logger && Logger->should_log(spdlog::level::trace))
            {
                Logger->trace(__FUN("binary_client         | registered NodeIds:"));
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | UnregisterNodes -->"));
            if (Logger && Logger->should_log(spdlog::level::trace))
            {
                Logger->trace(__FUN("binary_client         | Nodes to unregister:"));

                for (auto& id : params)
                {
                    Logger->trace(__FUN("    {}"), id);
                }
            }
    ...
    public:
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | OpenChannel -->"));
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | CloseSecureChannel -->"));
            try
            {
            ...
            {
                LOG_WARN(Logger, __FUN("closing secure channel failed with: {}"), exc.what());
            }
    ...
    private:
        ...
        Response Send(Request request) const
        {
            ...
            LOG_DEBUG(Logger, __FUN("binary_client         | send: id: {} handle: {}, UtcTime: {}"), ToString(request.TypeId, true), request.Header.RequestHandle, request.Header.UtcTime);
        ...
        void Receive()
        {
            ...
            LOG_DEBUG(Logger, __FUN("binary_client         | received message: Type: {}, ChunkType: {}, Size: {}, ChannelId: {}"), responseHeader.Type, responseHeader.Chunk, responseHeader.Size, responseHeader.ChannelId);
            ...
            else if (responseHeader.Type == MessageType::MT_ERROR)
            {
                ...
                //throw std::runtime_error(__FUN(stream.str()));
                throw std::exception(__FUN(stream.str()));
            ...
            if (responseHeader.Chunk == CHT_SINGLE)
            {
                ...
                {
                    LOG_WARN(Logger, __FUN("binary_client         | no callback found for message id: {}, handle: {}"), id, header.RequestHandle);
                    messageBuffer.clear();
                    return;
                }
        ...
        void parseMessage(std::size_t& dataSize, NodeId& id)
        {
            ...
            Stream >> raw;
            LOG_TRACE(Logger, __FUN("binary_client         | received message data: {}"), ToHexDump(buffer));
            ...
            if (!firstMsgParsed)
            {
                ...
                LOG_DEBUG(Logger, __FUN("binary_client         | got response id: {}, handle: {}"), ToString(id, true), header.RequestHandle);

                if (id == SERVICE_FAULT)
                {
                    LOG_WARN(Logger, __FUN("binary_client         | receive ServiceFault from Server with StatusCode: {}"), header.ServiceResult);
                }
                else if (header.ServiceResult != StatusCode::Good)
                {
                    LOG_WARN(Logger, __FUN("binary_client         | received a response from server with error status: {}"), header.ServiceResult);
                }
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | HelloServer -->"));
        ...
        RequestHeader CreateRequestHeader() const
        {
            ...
            headers.SessionAuthenticationToken = AuthenticationToken;
            headers.RequestHandle = GetRequestHandle();
        ...
        {
            LOG_DEBUG(Logger, __FUN("binary_client         | clearing cached references to server"));
